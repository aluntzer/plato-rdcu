...
struct cmp_info {
	...
	uint32_t cmp_size;            /* Compressed data size; measured in bytes */
	uint32_t ap1_cmp_size;        /* Adaptive compressed data size 1; measured in bytes */
	uint32_t ap2_cmp_size;        /* Adaptive compressed data size 2; measured in bytes */
